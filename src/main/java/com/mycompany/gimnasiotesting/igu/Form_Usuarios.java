...
public class Form_Usuarios extends javax.swing.JPanel {
        ...
        panelBorder1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(spTable, javax.swing.GroupLayout.DEFAULT_SIZE, 692, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if(table.getRowCount() > 0){
            if(table.getSelectedRow() != -1){
                ...
                mostrarMensaje("No se seleccionó ningun usuario", "Error", "Error al editar");
            }
        }
        else{
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if(table.getRowCount() > 0){
            if(table.getSelectedRow() != -1){
                ...
                mostrarMensaje("Usuario eliminado con éxito", "Info", "Borrado de usuario");
                cargarDatos();
            }
            else{
                mostrarMensaje("No se seleccionó ningun usuario", "Error", "Error al eliminar");
            }
        }
        else{
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        CargarUsuario pantallaCarga = new CargarUsuario();
        pantallaCarga.setFormUsuariosReference(this);
