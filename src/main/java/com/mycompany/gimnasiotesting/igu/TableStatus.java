...
public class TableStatus extends JLabel{
    ...
    private Miembro.Estado type;
    
    public Miembro.Estado getType() {
        return type;
    }
    ...
    public void setType(Miembro.Estado type){
        this.type = type;
